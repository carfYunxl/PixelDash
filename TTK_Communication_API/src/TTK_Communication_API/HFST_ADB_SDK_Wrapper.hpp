...
#ifdef OPEN_ADB
#include "../../dependency/Adb/include/HFST_ADB_SDK.h"
#include "../../dependency/Adb/include/HFST_ADB_SDK_ErrorCodeDef.h"

#ifdef _DEBUG
#pragma comment(lib, "../../dependency/Adb/lib/Debug/HFST_ADB_SDK.lib")
#else
#pragma comment(lib, "../../dependency/Adb/lib/Release/HFST_ADB_SDK.lib")
#endif
#endif
