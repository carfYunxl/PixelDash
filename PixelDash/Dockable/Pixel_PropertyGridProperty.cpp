...
Pixel_PropertyGridProperty::Pixel_PropertyGridProperty(const CString& strGroupName, DWORD_PTR dwData/* = 0*/, BOOL bIsValueList /*= FALSE*/)
	: CMFCPropertyGridProperty(strGroupName, dwData, bIsValueList)
{
}
Pixel_PropertyGridProperty::Pixel_PropertyGridProperty(
...
BOOL Pixel_PropertyGridProperty::HasButton() const {
	return TRUE;
}

Pixel_PropertyGridProperty::~Pixel_PropertyGridProperty() {}

void Pixel_PropertyGridProperty::OnDrawButton(CDC* pDC, CRect rect)
{
...
void Pixel_PropertyGridProperty::OnClickName(CPoint point)
{
	...
	if (group_property->GetSubItemsCount() == 0)
	{
		switch (static_cast<LINE_GROUP>(id))
		{
			...
			{
				Pixel_MainFrame* pMainFrame = (Pixel_MainFrame*)(theApp.m_pMainWnd);
				Pixel_Entity entity = pMainFrame->m_wndView.GetEntity();
...
BOOL Pixel_PropertyGridProperty::HasValueField() const { return FALSE; }

void Pixel_PropertyGridProperty::OnDrawName(CDC* pDC, CRect rect)
{
	ASSERT_VALID(this);
	ASSERT_VALID(pDC);
