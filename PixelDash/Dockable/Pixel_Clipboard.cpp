#include "pch.h"
#include "Pixel_Clipboard.h"

#pragma warning(disable : 4996)

CString Pixel_Clipboard::GetText()
{
	CString str;
	str = _T("");
...
BOOL Pixel_Clipboard::GetText(LPSTR lpszBuffer, int nBufSize)
{
	ASSERT(lpszBuffer);
	if (lpszBuffer == NULL)
		return FALSE;
...
int Pixel_Clipboard::GetTextLength()
{
#if _MFC_VER < 0x700
...
BOOL Pixel_Clipboard::SetText(LPCTSTR lpszBuffer)
{
	BOOL bSuccess = FALSE;
