...
Pixel_TestView::Pixel_TestView() noexcept {
}

Pixel_TestView::~Pixel_TestView() {
	DeleteObject(&m_Font);
}

BEGIN_MESSAGE_MAP(Pixel_TestView, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_WM_CONTEXTMENU()
	...
	ON_WM_PAINT()
	ON_WM_SETFOCUS()
	ON_NOTIFY(TVN_SELCHANGED, IDC_TEST_VIEW_TREE, &Pixel_TestView::OnTvnSelchangedTree)
END_MESSAGE_MAP()

int Pixel_TestView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void Pixel_TestView::OnSize(UINT nType, int cx, int cy)
{
	CDockablePane::OnSize(nType, cx, cy);
	AdjustLayout();
}

void Pixel_TestView::FillFileView()
{
...
void Pixel_TestView::OnContextMenu(CWnd* pWnd, CPoint point)
{
...
void Pixel_TestView::AdjustLayout()
{
...
void Pixel_TestView::OnProperties()
{
	AfxMessageBox(_T("属性...."));
}

void Pixel_TestView::OnFileOpen()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnFileOpenWith()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnDummyCompile()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnEditCut()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnEditCopy()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnEditClear()
{
	// TODO: 在此处添加命令处理程序代码
}

void Pixel_TestView::OnPaint()
{
...
void Pixel_TestView::OnSetFocus(CWnd* pOldWnd)
{
...
void Pixel_TestView::OnChangeVisualStyle()
{
...
void Pixel_TestView::OnTvnSelchangedTree(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMTREEVIEW pNMTreeView = reinterpret_cast<LPNMTREEVIEW>(pNMHDR);

	Pixel_MainFrame* pWndFrame = (Pixel_MainFrame*)theApp.m_pMainWnd;
	if ( pWndFrame )
	{
...
DRAW_TYPE Pixel_TestView::GetIndexByTitle(const CString& title)
{
